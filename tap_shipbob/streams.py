...
class ProductsStream(ShipBobStream):
    ...
    schema = th.PropertiesList(
        ...
        th.Property("bundle_root_information", th.ObjectType(
            th.Property("id", th.IntegerType),
        ...
        th.Property(
            "fulfillable_inventory_items", th.ArrayType(
                th.ObjectType(
                    th.Property("id", th.IntegerType),
                    th.Property("name", th.StringType),
        ...
        th.Property(
            "fulfillable_quantity_by_fulfillment_center", th.ArrayType(
                th.ObjectType(
                    th.Property("id", th.IntegerType),
                    th.Property("name", th.StringType),
...
class LocationsStream(ShipBobStream):
    ...
    schema = th.PropertiesList(
        ...
        th.Property("services", th.ArrayType(th.ObjectType(
        ...
        th.Property("fulfillment_center_type", th.ObjectType(
            th.Property("id", th.IntegerType),
            th.Property("name", th.StringType),
        )),
        th.Property("fulfillment_center_attributes", th.ArrayType(
            th.ObjectType(
                th.Property("id", th.IntegerType),
                th.Property("name", th.StringType),
            )
...
class OrdersStream(ShipBobStream):
    ...
    schema = th.PropertiesList(
        ...
        th.Property("recipient", th.ObjectType(
            th.Property("name", th.StringType),
            th.Property("email", th.StringType),
            th.Property("phone_number", th.StringType),
            th.Property("address", th.ObjectType(
        ...
        th.Property("shipments", th.ArrayType(th.ObjectType(
            ...
            th.Property("status", th.StringType),
            th.Property("status_details", th.ArrayType(
                th.ObjectType(
                    th.Property("name", th.StringType),
                    th.Property("description", th.StringType),
                    th.Property("id", th.IntegerType),
                    th.Property("inventory_id", th.IntegerType),
                    th.Property("exception_fulfillment_center_id", th.IntegerType),
                )
            )),
            ...
            th.Property("products", th.ArrayType(
                th.ObjectType(
                    ...
                    th.Property("name", th.StringType),
                    th.Property("sku", th.StringType),
                    th.Property("inventory_items", th.ArrayType(
                    th.ObjectType(
                        th.Property("id", th.IntegerType),
                        th.Property("name", th.StringType),
                        th.Property("quantity", th.IntegerType),
                        th.Property("quantity_committed", th.IntegerType),
                        th.Property("lot", th.StringType),
                        th.Property("expiration_date", th.DateTimeType),
                        th.Property("serial_numbers", th.ArrayType(th.StringType)),
                        th.Property("is_dangerous_goods", th.BooleanType)
                    ))),
                )
            )),
            th.Property("parent_cartons", th.ArrayType(
                th.ObjectType(
                    th.Property("type", th.StringType),
                    th.Property("barcode", th.StringType),
                    th.Property("measurements", th.ObjectType(
                    ...
                    th.Property("cartons", th.ArrayType(
                        th.ObjectType(
                            th.Property("id", th.IntegerType),
                            th.Property("type", th.StringType),
                            th.Property("barcode", th.StringType),
        ...
        th.Property("retailer_program_data", th.ObjectType(
